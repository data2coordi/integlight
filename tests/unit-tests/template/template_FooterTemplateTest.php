...
class template_FooterTemplateTest extends WP_UnitTestCase
{
    ...
    public function test_credits_are_displayed_by_default()
    {
        ...
        $this->assertStringContainsString('https://aurora-labo.tech/', $output, 'Theme author credit link not found.');
    ...
    public function test_credits_are_hidden_when_set_to_false()
    {
        ...
        $this->assertStringNotContainsString('https://aurora-labo.tech/', $output, 'Theme author credit link should not be present.');

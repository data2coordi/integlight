...
test("PC-01: メインメニュー → サブメニュー → サブサブメニューの開閉と閉じる確認", async ({
  ...
  console.log(
    "===== START: PC-01: メインメニュー → サブメニュー → サブサブメニューの開閉と閉じる確認 ====="
  );
  // 1. ページを開く
...
test("SP-01: メインメニュー → サブメニュー → サブサブメニューの開閉", async ({
  ...
  console.log(
    "===== START: SP-01: メインメニュー → サブメニュー → サブサブメニューの開閉 ====="
  );
...
test("PC-02: Tabでメイン→サブ→サブサブ開いて、ESCで全閉じ確認", async ({
  ...
  console.log(
    "===== START: PC-02: Tabでメイン→サブ→サブサブ開いて、ESCで全閉じ確認 ====="
  );
  // 1. ページを開く
  await page.goto("https://wpdev.auroralab-design.com/", {
    waitUntil: "networkidle",
...
test("PC-03: Tabで開いて Shift+Tabで戻りつつメニューが階層的に閉じる確認", async ({
  ...
  console.log(
    "===== START: PC-03: Tabで開いて Shift+Tabで戻りつつメニューが階層的に閉じる確認 ====="
  );
  // 1. ページを開く
  await page.goto("https://wpdev.auroralab-design.com/", {
    waitUntil: "networkidle",
...
test("PC-04: Tabでメイン→サブ→サブサブ→次のサブ", async ({ page }) => {
  console.log("===== START: PC-04: Tabでメイン→サブ→サブサブ→次のサブ =====");
  // 1. ページを開く
  await page.goto("https://wpdev.auroralab-design.com/", {
    waitUntil: "networkidle",
  });
...
test("モバイルでハンバーガーメニューをキーボード操作で開閉できる", async ({
  ...
  console.log(
    "===== START: モバイルでハンバーガーメニューをキーボード操作で開閉できる ====="
  );
  // モバイル表示に設定
  await page.setViewportSize({ width: 375, height: 800 });
...
test("SP-02: モバイルでTabでメイン→サブ→サブサブ開いて、ESCで全閉じ確認", async ({
  ...
  console.log(
    "===== START: SP-02: モバイルでTabでメイン→サブ→サブサブ開いて、ESCで全閉じ確認 ====="
  );
  // 1. モバイル表示に設定してページを開く
  await page.setViewportSize({ width: 375, height: 800 });
  await page.goto("https://wpdev.auroralab-design.com/", {
...
test("SP-03: Tabで開いて Shift+Tabで戻りつつメニューが階層的に閉じる確認", async ({
  ...
  console.log(
    "===== START: SP-03: Tabで開いて Shift+Tabで戻りつつメニューが階層的に閉じる確認 ====="
  );
  // 1. モバイル表示に設定してページを開く
  await page.setViewportSize({ width: 375, height: 800 });
  await page.goto("https://wpdev.auroralab-design.com/", {
...
test("アクセシビリティ: モバイルハンバーガーのaria-expanded/aria-hidden切替検証", async ({
  ...
  console.log(
    "===== START: アクセシビリティ: モバイルハンバーガーのaria-expanded/aria-hidden切替検証 ====="
  );
  // モバイル表示に設定
  await page.setViewportSize({ width: 375, height: 800 });
  await page.goto("https://wpdev.auroralab-design.com/", {

 ...
 *
 * @uses integlight_header_style()
 */
function integlight_custom_header_setup()
{
	add_theme_support(
		'custom-header',
		apply_filters(
			'integlight_custom_header_args',
			array(
				'default-image'      => '',
...
if (! function_exists('integlight_header_style')) :
	 ...
	 *
	 * @see integlight_custom_header_setup().
	 */
	function integlight_header_style()
	{
